...
OBJS += \
./Middleware/FatFs/option/ccsbcs.o \
./Middleware/FatFs/option/syscall.o 

C_DEPS += \
./Middleware/FatFs/option/ccsbcs.d \
...
clean-Middleware-2f-FatFs-2f-option:
	-$(RM) ./Middleware/FatFs/option/ccsbcs.cyclo ./Middleware/FatFs/option/ccsbcs.d ./Middleware/FatFs/option/ccsbcs.o ./Middleware/FatFs/option/ccsbcs.su ./Middleware/FatFs/option/syscall.cyclo ./Middleware/FatFs/option/syscall.d ./Middleware/FatFs/option/syscall.o ./Middleware/FatFs/option/syscall.su
