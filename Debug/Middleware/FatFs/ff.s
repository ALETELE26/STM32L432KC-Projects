...
.L296:
	...
	cmp	r3, #0
	beq	.L297
	.loc 1 2130 13 is_stmt 0 discriminator 1
	ldr	r3, [r7]
	cmp	r3, #0
	bne	.L298
.L297:
	.loc 1 2131 8 is_stmt 1
	add	r2, r7, #20
	ldr	r3, [r7, #40]
	add	r3, r3, r2
	movs	r2, #126
...
.L441:
	...
	cmp	r3, #0
	bne	.L439
	.loc 1 2637 26 is_stmt 0 discriminator 1
	ldr	r3, [r7, #112]
	subs	r3, r3, #1
	str	r3, [r7, #112]
	ldr	r3, [r7, #112]
...
.L468:
	...
	cmp	r3, #57344
	bcs	.L469
	.loc 1 2754 8 discriminator 3
	ldrh	r3, [r7, #28]	@ movhi
	strh	r3, [r7, #26]	@ movhi
	.loc 1 2754 14 discriminator 3
	b	.L465
.L469:
	.loc 1 2756 17
	ldrh	r3, [r7, #26]
...
.L483:
	...
	cmp	r3, #57344
	bcs	.L479
	.loc 1 2782 9 discriminator 3
	ldrh	r3, [r7, #28]	@ movhi
	strh	r3, [r7, #26]	@ movhi
	.loc 1 2782 15 discriminator 3
	b	.L478
.L479:
	.loc 1 2784 18
	ldrh	r3, [r7, #26]
...
.L541:
	...
	cmp	r3, #32
	beq	.L526
	.loc 1 3015 17 discriminator 2
	ldrh	r3, [r7, #36]
	cmp	r3, #46
	bne	.L527
	.loc 1 3015 31 discriminator 3
	ldr	r2, [r7, #24]
	ldr	r3, [r7, #20]
	cmp	r2, r3
	beq	.L527
.L526:
	.loc 1 3016 7 discriminator 4
	ldrb	r3, [r7, #38]
	orr	r3, r3, #3
	strb	r3, [r7, #38]
	.loc 1 3017 4 discriminator 4
	b	.L528
.L527:
	.loc 1 3020 6
	ldr	r2, [r7, #32]
...
.L534:
	...
	cmp	r2, r3
	bcc	.L536
	.loc 1 3050 8 discriminator 1
	ldrb	r3, [r7, #38]
	orr	r3, r3, #3
	strb	r3, [r7, #38]
	.loc 1 3051 7 discriminator 1
	ldr	r3, [r7, #28]
	str	r3, [r7, #32]
	.loc 1 3051 13 discriminator 1
	b	.L528
.L536:
	.loc 1 3053 18
	ldrh	r3, [r7, #36]
...
.L571:
	...
	ldrb	r3, [r3]
	strb	r3, [r7, #15]
	.loc 1 3260 43 discriminator 2
	ldrb	r3, [r7, #15]	@ zero_extendqisi2
	cmp	r3, #31
	bls	.L573
	.loc 1 3260 43 is_stmt 0 discriminator 1
	ldrb	r3, [r7, #15]	@ zero_extendqisi2
	cmp	r3, #58
	bne	.L571
.L573:
	.loc 1 3262 5 is_stmt 1
	ldrb	r3, [r7, #15]	@ zero_extendqisi2
	cmp	r3, #58
	bne	.L574
	.loc 1 3263 5
...
.L843:
	...
	str	r3, [r7, #92]
.L841:
	.loc 1 4974 39 discriminator 1
	ldr	r3, [r7, #76]
	cmp	r3, #0
	beq	.L842
	.loc 1 4974 39 is_stmt 0 discriminator 3
	ldr	r3, [r7, #92]
	cmp	r3, #0
	bne	.L843
.L842:
	.loc 1 4978 14 is_stmt 1
	ldr	r3, [r7, #84]
	adds	r3, r3, #1
	.loc 1 4978 9
	ubfx	r3, r3, #0, #9
...
.Letext0:
	...
	.file 3 "C:\\ST\\STM32CubeIDE_1.12.0\\STM32CubeIDE\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.12.3.rel1.win32_1.1.0.202410251130\\tools\\bin/../lib/gcc/arm-none-eabi/12.3.1/../../../../arm-none-eabi/include/sys/_stdint.h"
...
.Ldebug_macro0:
	...
	.uleb128 0x2f
	.4byte	.LASF500
	.file 7 "C:\\ST\\STM32CubeIDE_1.12.0\\STM32CubeIDE\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.12.3.rel1.win32_1.1.0.202410251130\\tools\\bin/../lib/gcc/arm-none-eabi/12.3.1/include/stdint.h"
	.byte	0x3
	.uleb128 0x30
	.uleb128 0x7
	.file 8 "C:\\ST\\STM32CubeIDE_1.12.0\\STM32CubeIDE\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.12.3.rel1.win32_1.1.0.202410251130\\tools\\bin/../lib/gcc/arm-none-eabi/12.3.1/../../../../arm-none-eabi/include/stdint.h"
	.byte	0x3
	.uleb128 0x9
	.uleb128 0x8
	.byte	0x5
	...
	.uleb128 0x6
	.4byte	.LASF502
	.file 9 "C:\\ST\\STM32CubeIDE_1.12.0\\STM32CubeIDE\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.12.3.rel1.win32_1.1.0.202410251130\\tools\\bin/../lib/gcc/arm-none-eabi/12.3.1/../../../../arm-none-eabi/include/sys/features.h"
	.byte	0x3
	.uleb128 0x8
	.uleb128 0x9
	.byte	0x5
	...
	.4byte	.Ldebug_macro5
	.byte	0x4
	.file 11 "C:\\ST\\STM32CubeIDE_1.12.0\\STM32CubeIDE\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.12.3.rel1.win32_1.1.0.202410251130\\tools\\bin/../lib/gcc/arm-none-eabi/12.3.1/../../../../arm-none-eabi/include/sys/_intsup.h"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0xb
	.byte	0x7
