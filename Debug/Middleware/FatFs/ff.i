...
# 1 "../Middleware/FatFs/ff.c"
# 21 "../Middleware/FatFs/ff.c"
# 1 "../Middleware/FatFs/ff.h" 1
# 23 "../Middleware/FatFs/ff.h"
...
# 92 "../Middleware/FatFs/ffconf.h"
#define FF_CODE_PAGE 866
# 121 "../Middleware/FatFs/ffconf.h"
#define FF_USE_LFN 1
#define FF_MAX_LFN 255
# 141 "../Middleware/FatFs/ffconf.h"
#define FF_LFN_UNICODE 0
# 153 "../Middleware/FatFs/ffconf.h"
...
# 192 "../Middleware/FatFs/ffconf.h"
#define FF_MULTI_PARTITION 0
# 201 "../Middleware/FatFs/ffconf.h"
#define FF_MIN_SS 512
#define FF_MAX_SS 512
# 211 "../Middleware/FatFs/ffconf.h"
#define FF_LBA64 0
...
# 259 "../Middleware/FatFs/ffconf.h"
#define FF_FS_NOFSINFO 0
# 271 "../Middleware/FatFs/ffconf.h"
#define FF_FS_LOCK 0
# 283 "../Middleware/FatFs/ffconf.h"
#define FF_FS_REENTRANT 0
#define FF_FS_TIMEOUT 1000
# 30 "../Middleware/FatFs/ff.h" 2
# 47 "../Middleware/FatFs/ff.h"
#define FF_INTDEF 2
...
# 49 "../Middleware/FatFs/ff.h" 2

# 49 "../Middleware/FatFs/ff.h"
...
typedef WORD WCHAR;
# 72 "../Middleware/FatFs/ff.h"
typedef QWORD FSIZE_t;



typedef DWORD LBA_t;
# 105 "../Middleware/FatFs/ff.h"
typedef char TCHAR;
#define _T(x) x
#define _TEXT(x) x
# 132 "../Middleware/FatFs/ff.h"
typedef struct {
 BYTE fs_type;
 BYTE pdrv;
 BYTE ldrv;
...
# 366 "../Middleware/FatFs/ff.h"
WCHAR ff_oem2uni (WCHAR oem, WORD cp);
WCHAR ff_uni2oem (DWORD uni, WORD cp);
DWORD ff_wtoupper (DWORD uni);
# 393 "../Middleware/FatFs/ff.h"
#define FA_READ 0x01
...
# 23 "../Middleware/FatFs/ff.c" 2
# 35 "../Middleware/FatFs/ff.c"
...
# 240 "../Middleware/FatFs/ff.c"
#define LEAVE_FF(fs,res) return res
# 249 "../Middleware/FatFs/ff.c"
#define LD2PD(vol) (BYTE)(vol)
#define LD2PT(vol) 0
# 259 "../Middleware/FatFs/ff.c"
#define SS(fs) ((UINT)FF_MAX_SS)
# 270 "../Middleware/FatFs/ff.c"
#define GET_FATTIME() ((DWORD)(FF_NORTC_YEAR - 1980) << 25 | (DWORD)FF_NORTC_MON << 21 | (DWORD)FF_NORTC_MDAY << 16)
# 291 "../Middleware/FatFs/ff.c"
...
# 460 "../Middleware/FatFs/ff.c"
static FATFS *FatFs[1];
static WORD Fsid;
# 512 "../Middleware/FatFs/ff.c"
...
static inline void mem_set(void *mem, int value, unsigned int size)
{
 asm volatile ( "orrs	%[size], %[size]\n\t"
     "beq	2f\n\t"
     "1:\n\t"
...
static inline void mem_cpy(void *dst, const void *src, unsigned int size)
{
 asm volatile ( "orrs	%[size], %[size]\n\t"
     "beq	2f\n\t"
     "1:\n\t"
...
static int str_chr (const char* str, int chr)
{
 asm volatile ( "1:\n\t"
     "ldrb	r0, [%[str]], #1\n\t"
     "cbz	r0, 2f\n\t"
...
static int mem_cmp (const void* dst, const void* src, UINT cnt)
{
 ...
 asm volatile ( "1:\n\t"
     ...
     "bne	1b\n\t"
     "2:\n\t"
     : [dst]"+r"(dst), [src]"+r"(src), [cnt]"+r"(cnt), [r]"=&r"(r)
     :
     : "r0", "r1" );
 return r;
}
# 784 "../Middleware/FatFs/ff.c"
static int dbc_1st (BYTE c)
{
# 797 "../Middleware/FatFs/ff.c"
 if (c != 0) return 0;
...
)
{
 ...
 if (res == FR_OK) {
  if (fs->fs_type == 3 && fs->fsi_flag == 1) {
   ...
   memset_32(fs->win, 0, (sizeof fs->win) / 4);
...
# 2709 "../Middleware/FatFs/ff.c"
 return res;
}
# 2721 "../Middleware/FatFs/ff.c"
...
)
{
 ...
 for (;;) {
  ...
  wc = (WCHAR)uc;
  if (wc < ' ' || ((wc) == '/' || (wc) == '\\')) break;
  if (wc < 0x80 && str_chr("*:<>|\"\?\x7F", (int)wc)) return FR_INVALID_NAME;
...
# 3041 "../Middleware/FatFs/ff.c"
 ...
 return FR_OK;
# 3146 "../Middleware/FatFs/ff.c"
}
# 3155 "../Middleware/FatFs/ff.c"
...
# 3309 "../Middleware/FatFs/ff.c"
 vol = 0;

 return vol;
}
# 3395 "../Middleware/FatFs/ff.c"
...
)
{
 ...
 if (sign == 0xAA55 && !mem_cmp(fs->win + 0, "\xEB\x76\x90" "EXFAT   ", 11)) return 1;

 b = fs->win[0];
 if (b == 0xEB || b == 0xE9 || b == 0xE8) {
  if (sign == 0xAA55 && !mem_cmp(fs->win + 82, "FAT32   ", 8)) {
   return 0;
  }
 ...
 *rfs = fs;
 ...
 fs->dirbuf = DirBuf;
# 3707 "../Middleware/FatFs/ff.c"
 return FR_OK;
}
# 3717 "../Middleware/FatFs/ff.c"
  ...
  if (mode & (0x08 | 0x10 | 0x04)) {
   ...
   if (res == FR_OK && (mode & 0x08)) {
    ...
    if (fs->fs_type == 4) {
     ...
     fs->dirbuf[4] = 0x20;
     st_dword(fs->dirbuf + 8, ((DWORD)(2022 - 1980) << 25 | (DWORD)1 << 21 | (DWORD)1 << 16));
     fs->dirbuf[33] = 1;
     res = store_xdir(&dj);
...

    {
     ...
     tm = ((DWORD)(2022 - 1980) << 25 | (DWORD)1 << 21 | (DWORD)1 << 16);
...
# 3949 "../Middleware/FatFs/ff.c"
  if (res == FR_OK) {
   ...
   memset_32(fp->buf, 0, (sizeof fp->buf) / 4);
