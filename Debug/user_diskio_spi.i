# 1 "../Application/SDCard/user_diskio_spi.c"
...
# 1 "../Application/SDCard/user_diskio_spi.c"
# 27 "../Application/SDCard/user_diskio_spi.c"
# 1 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Application/SDCard/user_diskio_spi.h" 1
# 27 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Application/SDCard/user_diskio_spi.h"
#define _USER_DISKIO_SPI_H 

# 1 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/diskio.h" 1
...
# 1 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h" 1
# 23 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
...
# 1 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h" 1
...
# 33 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
...
# 92 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_CODE_PAGE 866
# 121 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_USE_LFN 1
#define FF_MAX_LFN 255
# 141 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_LFN_UNICODE 0
# 153 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
...
# 174 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_VOLUMES 1
...
# 192 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_MULTI_PARTITION 0
# 201 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_MIN_SS 512
#define FF_MAX_SS 512
# 211 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_LBA64 0
...
# 232 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_FS_TINY 0
...
# 259 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_FS_NOFSINFO 0
# 271 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_FS_LOCK 0
# 283 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ffconf.h"
#define FF_FS_REENTRANT 0
#define FF_FS_TIMEOUT 1000
# 30 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h" 2
# 47 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
#define FF_INTDEF 2
...
# 49 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h" 2

# 49 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
...
typedef WORD WCHAR;
# 72 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
typedef QWORD FSIZE_t;



typedef DWORD LBA_t;
# 105 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
typedef char TCHAR;
#define _T(x) x
#define _TEXT(x) x
# 132 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
typedef struct {
 BYTE fs_type;
 BYTE pdrv;
 BYTE ldrv;
 ...
 DWORD last_clst;
 DWORD free_clst;
# 163 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
 DWORD n_fatent;
 DWORD fsize;
 LBA_t volbase;
 LBA_t fatbase;
...
# 304 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
...
# 366 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
WCHAR ff_oem2uni (WCHAR oem, WORD cp);
WCHAR ff_uni2oem (DWORD uni, WORD cp);
DWORD ff_wtoupper (DWORD uni);
# 393 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/ff.h"
#define FA_READ 0x01
...
#define AM_DIR 0x10
#define AM_ARC 0x20
# 13 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Middleware/FatFs/diskio.h" 2
...
# 30 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Application/SDCard/user_diskio_spi.h" 2
...
# 28 "../Application/SDCard/user_diskio_spi.c" 2
...
#define FLAG_SET SET
# 29 "../Application/SDCard/user_diskio_spi.c" 2
...
#define SPI_SD SPI1
#define SD_INI_SPEED 1
# 45 "../Application/SDCard/user_diskio_spi.c"
#define SD_MAX_SPEED 1

#define SD_USE_DMA 


#define SD_DMA_CNTR_RX DMA1
#define SD_DMA_CNTR_RX_NUMBER 1
#define SD_DMA_CHANNEL_RX_DIR DMA1_Channel2
#define SD_DMA_CHANNEL_RX_NUMBER 2
#define SD_DMA_CNTR_TX DMA1
#define SD_DMA_CNTR_TX_NUMBER 1
#define SD_DMA_CHANNEL_TX_DIR DMA1_Channel3
#define SD_DMA_CHANNEL_TX_NUMBER 3

#define GPIO_SD_CS_PORT GPIOA
#define GPIO_SD_CS_PIN 4U
...
#define SELECT() (GPIO_SD_CS_PORT->BSRR |= (0x1UL << (GPIO_SD_CS_PIN)))
#define DESELECT() (GPIO_SD_CS_PORT->BSRR |= (0x1UL << ((GPIO_SD_CS_PIN)+16U)))
# 105 "../Application/SDCard/user_diskio_spi.c"
static void set_sd_interface_speed(uint8_t speed)
{
 if (speed > 7) speed = 7;
 ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->CR1 &= ~(0x1UL << (6U));
 ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->CR1 &= ~(0x07UL<<(3U));
 ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->CR1 |= (uint32_t)(speed<<(3U));
 ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->CR1 |= (0x1UL << (6U));
}
...
{
 *((volatile uint8_t *)&((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->DR) = wval;
 while(!(((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->SR & (0x1UL << (0U)))) ;
 while (((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->SR & (0x1UL << (7U))) ;
 return *((volatile uint8_t *)&((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->DR);
}
...
{
 uint8_t tmp = 0xFF;
 DMA_Channel_TypeDef *dma_RX = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x001CUL));
 DMA_Channel_TypeDef *dma_TX = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x0030UL));

 ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1ENR |=(0x1UL <<(1 -1));
 ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1ENR |=(0x1UL <<(1 -1));

 if(((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))==((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL)))
 {
  ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR |=((0x1UL << (12U)));
 }
 else
 {
  ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1 |=((0x1UL << (15U)));
 }
 ...
 while ((dma_RX->CCR &= ~((0x1UL << (0U)))) || (dma_TX->CCR &= ~((0x1UL << (0U))))) { }

 ((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL)))->IFCR |= (0x1UL << ((3 -1)*4));
 ((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL)))->IFCR |= (0x1UL << ((2 -1)*4));

 if(((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL)))==((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL))))
 {
  ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x00A8UL))->CSELR &= ~((0xFUL << (4U)));
  ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x00A8UL))->CSELR |= (0x1UL << (4U));
 }
 else
 {
  ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x00A8UL))->CSELR &= ~((0xFUL << (8U)));
  ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x00A8UL))->CSELR |= (0x4UL << (8U));
 }
 if(((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL)))==((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL))))
 {
 ...
 {
  ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x00A8UL))->CSELR &= ~((0xFUL << (12U)));
  ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x00A8UL))->CSELR |= (0x4UL << (12U));
 }

 dma_RX->CCR &= ~ ((0x1UL << (3U)) | (0x1UL << (1U)) | (0x1UL << (2U)));

 dma_RX->CCR &= ~ ((0x3UL << (12U)));
 dma_RX->CCR |= ((0x1UL << (12U)) | (0x2UL << (12U)));
 dma_TX->CCR &= ~ ((0x3UL << (12U)));
 dma_TX->CCR |= ((0x2UL << (12U)));

 if(type == SPI_Transfer_Receive)
  {
   dma_RX->CCR &= ~((0x1UL << (6U)));
   dma_RX->CCR |= ((0x1UL << (7U)));
   dma_TX->CCR &= ~((0x1UL << (6U)) | (0x1UL << (7U)));
   dma_TX->CMAR = (uint32_t)&tmp;
   dma_RX->CMAR = (uint32_t)buff;
  }
  else if (type == SPI_Transfer_Transmit)
  {
   dma_RX->CCR &= ~((0x1UL << (6U)) | (0x1UL << (7U)));
   dma_TX->CCR &= ~((0x1UL << (6U)));
   dma_TX->CCR |= ((0x1UL << (7U)));
   dma_TX->CMAR = (uint32_t)buff;
   dma_RX->CMAR = (uint32_t)&tmp;
  }
 dma_RX->CCR &=~ ((0x1UL << (4U)));
 dma_TX->CCR |= ((0x1UL << (4U)));
 dma_RX->CPAR = dma_TX->CPAR = (uint32_t)(&((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->DR);
 dma_RX->CNDTR = dma_TX->CNDTR = (uint32_t)buff_size;


 ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->CR2 |= ((0x1UL << (0U)) );
 ...
 while(!(((((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL)))->ISR) & (0x1UL << (1+((3 -1)*4))))
 &&((((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL)))->ISR) & (0x1UL << (1+((2 -1)*4)))))) {};
 ...
 dma_TX->CCR &= ~((0x1UL << (0U)));
    ...
    while((((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->SR) & ((0x3UL << (9U))))
    {

     tmp=(uint8_t)(((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->DR);
    }
    (void)tmp;

    ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))->CR2 &= ~((0x1UL << (1U)) | (0x1UL << (0U)));
}
# 269 "../Application/SDCard/user_diskio_spi.c"
static volatile DSTATUS Stat = 0x01;
...
static BYTE wait_ready(void)
{
 ...
 do {
  res = spi_rw(0xFF);
  if (rcc_msGetTicks() - initialTick > 100) {
   res = 0;
   break;
  }
 } while (res != 0xFF);
...
static BYTE send_cmd(BYTE cmd, LBA_t arg)
{
 ...
 (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL))->BSRR |= (0x1UL << ((4U)+16U)));
...
DSTATUS USER_SPI_initialize(BYTE drv)
{
 ...
 (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL))->BSRR |= (0x1UL << ((4U)+16U)));
 set_sd_interface_speed(1);
 (((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL))->BSRR |= (0x1UL << (4U)));

 for(n=10; n; n--) spi_rw(0xFF);

 if(0x01 == send_cmd((0x40+0), 0))
 {

  if(0x01 == send_cmd((0x40+8), 0x1AA))
  {
   ...
   if((0x01 == ocr[2]) && (0xAA == ocr[3]))
   {
    ...
    while(send_cmd((0xC0+41), (1UL << 30)));

    if(0x00 == send_cmd((0x40+58), 0))
    {
...
# 444 "../Application/SDCard/user_diskio_spi.c"
 spi_rw(0xFF);
 spi_rw(0xFF);
 return 1;
}
...
DRESULT USER_SPI_read(BYTE drv, BYTE *buff, LBA_t sector, UINT count)
{
 ...
 if(1 == count)
 {
  ...
  if(0x00 == send_cmd((0x40+17), sector))
  {
 ...
 else
 {
  ...
  if(0x00 == send_cmd((0x40+18), sector))
  {
   do {
...
# 506 "../Application/SDCard/user_diskio_spi.c"
  spi_rw(0xFF);
  spi_rw(0xFF);
...
DRESULT USER_SPI_write(BYTE drv, const BYTE *buff, LBA_t sector, UINT count)
{
 ...
 if(1 == count)
 {
  ...
  if((0x00 == send_cmd((0x40+24), sector)) && xmit_datablock(buff, 0xFE)) count = 0;
 }
 else
 {

  if(CardType & (0x02|0x04)) send_cmd((0xC0+23), count);
  if(0x00 == send_cmd((0x40+25), sector))
  {
   do {
...
DRESULT USER_SPI_ioctl(BYTE drv, BYTE ctrl, void *buff)
{
 ...
 case 1:
  ...
  if((0x00 == send_cmd((0x40+9), 0)) && rcvr_datablock(csd, 16))
  {
   if((csd[0] >> 6) == 1)
   {
 ...
 case 11:
  ...
  if((0x00 == send_cmd((0x40+9), 0)) && rcvr_datablock(ptr, 16)) res = RES_OK;
  break;

 case 12:

  if((0x00 == send_cmd((0x40+10), 0)) && rcvr_datablock(ptr, 16)) res = RES_OK;
  break;
