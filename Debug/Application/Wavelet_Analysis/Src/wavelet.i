# 0 "../Application/Wavelet_Analysis/Src/wavelet.c"
...
# 1 "../Application/Wavelet_Analysis/Src/wavelet.c"
...
#define FLAG_SET SET
# 12 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Application/Wavelet_Analysis/Inc/wavelet.h" 2
...
# 13 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Application/Wavelet_Analysis/Inc/wavelet.h" 2
...
# 8 "../Application/Wavelet_Analysis/Src/wavelet.c" 2
...
void wavelet_Init(Wavelet_t *w){
 ...
 w->mother=
# 16 "../Application/Wavelet_Analysis/Src/wavelet.c" 3 4
          ((void *)0)
# 16 "../Application/Wavelet_Analysis/Src/wavelet.c"
              ;
 w->width=0;
 w->four_wavelen=0.0f;
}
...
void morlet_Init(Morlet_t *mor,float32_t bandwidth){
 ...
 mor->base.mother=
# 28 "../Application/Wavelet_Analysis/Src/wavelet.c" 3 4
                 ((void *)0)
# 28 "../Application/Wavelet_Analysis/Src/wavelet.c"
                     ;
 mor->base.width=0;
 mor->base.doublesided=
# 30 "../Application/Wavelet_Analysis/Src/wavelet.c" 3 4
                      0
# 30 "../Application/Wavelet_Analysis/Src/wavelet.c"
                           ;
 mor->base.imag_frequency=
# 31 "../Application/Wavelet_Analysis/Src/wavelet.c" 3 4
                         0
# 31 "../Application/Wavelet_Analysis/Src/wavelet.c"
                              ;
 mor->fb = bandwidth;
...
# 50 "../Application/Wavelet_Analysis/Src/wavelet.c"
void morlet_Gen_Freq(Morlet_t *mor, uint32_t size){

 mor->base.width = size;
 float32_t toradians = (6.28318531f)/(float32_t)size;
 float32_t coef;
 arm_sqrt_f32((float32_t)(6.28318531f), &coef);
 coef *= 0.75112554446f;
 ...
 arm_offset_f32(V, -(2.0f * 3.14159265358979f * mor->fb), V, size);
