# 0 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Core/Src/cwt_probe.c"
...
# 1 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Core/Src/cwt_probe.c"
# 9 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Core/Src/cwt_probe.c"
...
#define FLAG_SET SET
# 10 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Core/Src/cwt_probe.c" 2
...
# 11 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Core/Src/cwt_probe.c" 2
...
# 12 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Core/Src/cwt_probe.c" 2
...
# 13 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Core/Src/cwt_probe.c" 2
...
int main (void)
{
 ...
 rcc_SysTick_config(80000000/8000);

 ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CPACR |= ((3UL << 10*2) | (3UL<< 11*2));

 uart_UART2_GPIO_config();
 uart_UART2_config(80000000,115200);

 float32_t *mySignal=createChirp(1024, 0.125, 50.0f, 300.0f);



 complex_t output[50 * 128];
 complex_t *cwt_Data=output;
 arm_fill_f32(0.0f, (float32_t*)cwt_Data,2*50*128);

 Morlet_t mor;
 morlet_Init(&mor, 1.0f);

 Scales_t scales;
 scales_Init(&scales, (Wavelet_t*)&mor, FCWT_LOGSCALES, 1024, 50.0f, 300.0f,50);

 cwt(&mor, &scales, mySignal, 128, cwt_Data);
 ...
 printf("END\r\n");
# 68 "C:/Users/Cuba/Documents/uni/STM32/STM32L432KC/Core/Src/cwt_probe.c"
 while(1)
 {
